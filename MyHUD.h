...
public:
	...
	AMyHUD();//resharper? visual assist check discord
	...
	UPROPERTY() TArray <USoundBase*> songs;
	...
	UPROPERTY() UAudioComponent* songTwoAudioComponent;
	UPROPERTY() UAudioComponent* songThreeAudioComponent;
	UPROPERTY() UAudioComponent* songFourAudioComponent;
	UPROPERTY() UAudioComponent* songFiveAudioComponent;
	UPROPERTY() UAudioComponent* songSixAudioComponent;
	UPROPERTY() UAudioComponent* songSevenAudioComponent;
	UPROPERTY() UAudioComponent* songEightAudioComponent;
...
public:
	...
	UPROPERTY() TArray<int> newSongIndexArr;
